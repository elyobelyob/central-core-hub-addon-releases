...
### Details (v1.0.64)
- Security: options logging now redacts `mqtt_cert_bundle` and `mqtt_password` fields to prevent certificate content exposure in logs
- Chore: bumped package metadata and repository version to `1.0.64`
